...
echo "=== RESTORE IMMAGINI VECCHIE SMS-MAN CLONE ==="
echo "Data: $(date)"

# Percorsi
SOURCE_DIR="/home/sms-man-clone/frontend/public/IMMAGINI_VECCHIE"
PROJECT_ROOT="/home/sms-man-clone/frontend"
LOG_FILE="/home/sms-man-clone/frontend/image-restore-log-vecchie.csv"
...
echo "=== PROCESSAMENTO IMMAGINI VECCHIE ==="
...
# Report finale
cat > /home/sms-man-clone/image-restore-report-vecchie.txt << EOF
=== REPORT RESTORE IMMAGINI VECCHIE SMS-MAN CLONE ===
Data: $(date)
...
echo "Report salvato in: /home/sms-man-clone/image-restore-report-vecchie.txt"
